...
public class CustomerLogin extends JFrame {
	protected static final CustomerLogin Account = null;
...
//}
	...
	public CustomerLogin() {
		...
		JLabel lblAdminLogin = new JLabel("Customer Login ");
		lblAdminLogin.setForeground(Color.GRAY);
		lblAdminLogin.setFont(new Font("Tahoma", Font.PLAIN, 18));
		
		JLabel lblEnterName = new JLabel("Customer Name:");
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			{
			Customer_Transaction.main(new String[]{});
				frame.dispose();
